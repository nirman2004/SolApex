...
const Navbar = () => {
  const { userData, userAuthentication, isLoggedIn } = useAuth();
      ...
      <div className={`navbar ${navbarBgColor}  h-5`}>
        <div className="navbar-start">
          <div className="dropdown">
            ...
            >
              <li className="mb-3">
                <a className="text-2xl">Feature</a>
              </li>
              <li className="mb-3">
                <Link className="text-2xl" to="./News">
                  News
                </Link>
              </li>
              <li className="mb-3">
        ...
        <div className="navbar-center hidden lg:flex">
          <ul className="menu menu-horizontal px-1">
            <li>
              <Link to="/Feature" className="text-2xl">
                Feature
              </Link>
            </li>
            <li>
        ...
        <div className="navbar-end">
          {isLoggedIn ? (
            <Link
              className="btn mr-2 bg-blue-300 hover:bg-pink-600 text-1xl font-bold"
              to="/Logout"
            >
              Logout
            </Link>
