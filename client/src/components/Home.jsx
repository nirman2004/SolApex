  ...
  return (
    ...
    >
      ...
      <main className="text-right ">
        <div
          style={{ width: "750px", height: "400px", borderRadius: "25px" }}
          className=" float-left mt-10 ml-5 "
        >
          <p
            style={{ fontSize: "40px" }}
            className="t  mr-9 mt-50  font-lexend-exa font-semibold text- mr-4"
          >
          ...
          <Link
            ...
            className="btn mr-2  bg-pink-400  hover:bg-blue-200  font-bold float-left"
            to="/Feature"
          >
            Get Started
          </Link>
